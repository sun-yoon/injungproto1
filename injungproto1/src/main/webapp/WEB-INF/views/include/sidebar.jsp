			...
			<ul class="nav navbar-nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="#" data-toggle="modal" data-target="#pick-chart"><i class="fa fa-pie-chart"></i>
									PICK CHART
								</a>
							</li>
     						 ...
     						 <!-- Modal content-->
     							<div class="modal-content">
        							<div class="modal-header">
        					 		...
        					 		<div class="modal-body">
										<input type="password" id="password_m" name="password_m" class="form-control"
     						 ...
     						 <!-- Modal content-->
     							<div class="modal-content">
        							<div class="modal-header">
        					 		...
        					 		<div class="modal-body">
										<input type="password" id="password_d" name="password_d" class="form-control"
											placeholder="PASSWORD" /> 
										<input type="hidden" id="authpw" name="authpw" value="${authUser.password}" >
									</div>
									<div class="modal-footer">
